...
<div id="mother-div">
    <div id="customers-nav">
        <div id="tag-queries">
            ...
            $query = "SELECT COUNT(DISTINCT tbl_orders.order_id) AS user_count FROM tbl_orders WHERE status = 'Delivered'";
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function loadProducts(productId = "all", status = "Delivered") {
